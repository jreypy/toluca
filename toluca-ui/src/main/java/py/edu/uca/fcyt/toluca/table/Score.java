...
class Score extends JPanel {
	...
	public void paint(Graphics g)
	{
		...
		//se pintan las lneas divisorias del puntaje
...
//		gr.scale(getHeight() / 390.0, getHeight() / 390.0);
		...
		//se pintan los puntajes representados por fsforos
	...
	//dibuja las lneas divisorias del puntaje
