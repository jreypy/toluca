...
class FaceState extends BasicState
{
	...
	/**
     * Crea un nuevo FaceState a partir de los parmetros pasados
     * @param x		posicin x de la cara
     * @param y		posicin y de la cara
     * @param angle	ngulo de la cara
     * @param scale	escala de la cara
     * @param offX	posicin x del centro de los objetos internos
     * @param offY	posicin y del centro de los objetos internos
     */
	public FaceState
	(
