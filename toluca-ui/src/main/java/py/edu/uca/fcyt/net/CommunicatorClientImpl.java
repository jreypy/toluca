 ...
 * @author CYT UCA
 */
public class CommunicatorClientImpl extends CommunicatorClient {

    /**
     * @param client
     */
    private RoomClient roomClient;
    protected Logger logeador = Logger.getLogger(CommunicatorClientImpl.class.getName());
    private String serverString;
    private int portNumber;
    private boolean loggedIn = false;
    private static final int SOCKET_TIMEOUT = 60000;

    public CommunicatorClientImpl(RoomClient client, String serverString, Integer portNumber) throws IOException {
    ...
    public int init() throws IOException {
        ...
        /*Agregado por aa para cortar la comunicacin*/
    ...
    public void connectionFailed(String msg) {
        logeador.log(TolucaConstants.CLIENT_ERROR_LOG_LEVEL, "Fall la conexin: " + msg);
    }
