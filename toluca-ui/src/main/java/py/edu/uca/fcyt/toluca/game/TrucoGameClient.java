...
//		logeador.log(TolucaConstants.CLIENT_DEBUG_LOG_LEVEL, "Se crea un nuevo truco Game Client");
	...
	public void startGameClient()
	{
		...
		//TODO Aca comentamos el startHandConfirmatedClient para probar porque no se deben disparar los eventos automticamente
	...
	public void cardsDeal(TrucoEvent event)
	{
		...
		new Exception("En cardsDeal. Ac se tendran que recibir las cartas").printStackTrace(System.out);
	}
...
//				logeador.log(TolucaConstants.CLIENT_DEBUG_LOG_LEVEL, tPlayer.getName()+"confirmado");
	...
	private void startHandConfirmatedClient()
	{
		...
		else
		{
			...
			trucoHand = trucoHandCli;		// Truco Julstico para evitar el STRESS. Muy feo, pero cumple el objetivo: EVITAR STRESS
