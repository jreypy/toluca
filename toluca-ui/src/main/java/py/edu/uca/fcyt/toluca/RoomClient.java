...
public class RoomClient extends Room implements ChatPanelContainer,
    ...
    public RoomClient(RoomUING rui) {
        ...
        try {
            ...
            rui.getLoginPanel().getJLestado().setText("<html><font color=\"ff0000\">Problemas al iniciar la conexin: " + e.getMessage() + "</font>");
            rui.getLoginPanel().getJLestado().setToolTipText("<html><font color=\"ff0000\">Problemas al iniciar la conexin: " + e.getMessage() + "</font>");
            rui.getLoginPanel().setToolTipText("<html><font color=\"ff0000\">Problemas al iniciar la conexin: " + e.getMessage() + "</font>");
            rui.getJEPanuncios().setToolTipText("<html><font color=\"ff0000\">Problemas al iniciar la conexin: " + e.getMessage() + "</font>");
