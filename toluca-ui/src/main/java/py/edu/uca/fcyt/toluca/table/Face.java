...
class Face implements Animable, StateListener
{
	...
	/**
     * Retorna el rea afectada por el pintado del texto si
	...
	/**
     * Agrega una nueva posicin a la cola.
     * @param x 	coordenada x de la nueva posicin
     * @param y		cooredenada y de la nueva posicin
     */
	...
	synchronized public void paint(int buffIndex)
	{
		...
		// translada el orgen a la coordenada
		...
		// translada el orgen a la coordenada
		// (x, y) del centro de los dems objetos
		grOut2.translate
		(
	...
	synchronized private void drawChair(Graphics2D grOut)
	{
		...
		// si la carita est seleccionada, dibujar el
		// borde amarillo
		if (highlighted)
		{
			try
	...
	/**
     * Devuelve verdadero si x e y estn dentro del cuadrito.
     * Las coordenadas pasadas deben ser las transformadas por 
     * el AffineTransform del Graphics2D en donde se pint
     * la carita.
	...
	/**
     * Devuelve las coordenadas de 2 tringulos equiltero, el
     * segundo ms chico que el primero.
     * @return 	Una matriz de coordenadas, donde la posicin
     *			i = 0, 1 para el primer y segundo tring. resp.
	...
	/** Este mtodo es llamado cuando un jugador canta alguna jugada
	...
	synchronized private void drawDialog(Graphics2D grOut)
	{
		...
		// obtiene las lneas de texto a mostrar
		...
		// aade 50 puntos al ancho y al alto
		width = textWidth + 50;
	...
	/**
     * Dibuja la carita 
     * @param biOut		lugar donde se dibujar la carita
	...
	) 
	{
		...
		// translada la carita a su posicin
		afTrans.translate
		(
	...
	/**
     * Retorna el tiempo restante de animacin
     */
    ...
    /**
     * Retorna un Graphics2D con transformacin
