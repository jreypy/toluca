...
public class TrucoTable extends JPanel implements ComponentListener {
    ...
    private void initialize() {
        ...
        this.add(getLogChatPanel(), BorderLayout.SOUTH);
        this.add(getJpLeftPanel(), BorderLayout.WEST);
        this.add(getJpCantos(), BorderLayout.NORTH);
        this.add(getJPmedio(), BorderLayout.CENTER);
    ...
    private JPanel getJPanel() {
        if (jPanel == null) {
            ...
            jPanel.add(getScore(), BorderLayout.CENTER);
            jPanel.add(getConexionTestPanel(), BorderLayout.SOUTH);
        }
        return jPanel;
    }
