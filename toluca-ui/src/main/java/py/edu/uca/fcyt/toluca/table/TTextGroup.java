...
class TTextGroup implements Animable, StateListener
{
	...
	/** Agrega un texto a la lnea de texto */
	...
	/** Retorna el 'index'-simo {@link TableText} */
	...
	/** Normaliza la duracin de todos los TableText
	 * y agrega una pausa extra.
	 * Agrega una pausa a todos los TableTexts de tal
	 * manera que todas terminen al mismo tiempo. El
	 * TableText de mayor duracin no tiene pausa agregada.
	 * Finalmente agrega una pausa de duracin
	 * <code>duration</code>  
	 */
