...
class TableCard implements Animable, StateListener
{
	...
	/**
     * Construye un TableCard sin carta en l
     */
	public TableCard()
	{
		biBack = createBack();
	 ...
	 * con duracin de transicin igual a 'duration'
	 */
    ...
    /**
     * Avanza la animacin de esta carta
     */
    public void advance()
    {
    	states.advance();
    ...
    /**
     * Retorna el tiempo restante de animacin de la carta
     */
...
//			System.out.println("Card added: " + card.hashCode());
	...
	/**
     * Retorna el ltimo estado de este TableCard
     */
