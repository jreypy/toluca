...
public class PlayTable extends JPanel {
    ...
    private BufferedImage[] biBuff = null; // Bfer de la mesa a pintar

    private AffineTransform afTrans = null; // Transformacin a aplicar
    ...
    /**
     * Evento de cambio de tamao del componente
     * 
     * @param e
     */
    protected void pTablecomponentResized(ComponentEvent e) {
        ...
        // obtiene las coordenadas del rea de pintado
        bounds = getBounds();

        // establece la escala y el desplazamiento de la mesa
        // con respecto al Graphic donde se la dibujar
        ...
        // crea la transformacin y la carga
        afTrans = new AffineTransform();
