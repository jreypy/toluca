...
public class RoomUING extends JApplet {
    ...
    private JPanel jProomPanel = null;
    ...
    protected JPanel getPanelPrincipal() {
        if (panelPrincipal == null) {
            ...
            panelPrincipal.add(getPanelTitle(), BorderLayout.NORTH);
            panelPrincipal.add(getPanelConMargen(),
                    BorderLayout.CENTER);
    ...
    private JPanel getPanelConMargen() {
        if (panelConMargen == null) {
            ...
            panelConMargen.add(getPanelPaneles(), BorderLayout.CENTER);
    ...
    private JPanel getPanelPaneles() {
        if (panelPaneles == null) {
            ...
            panelPaneles.add(getPanelControl(), BorderLayout.WEST);
            panelPaneles.add(getPanelCentral(), BorderLayout.CENTER);
            panelPaneles.add(getJPanel(), BorderLayout.EAST);
        }
        return panelPaneles;
    }
    ...
    private JPanel getPanelControl() {
        if (panelControl == null) {
            ...
            panelControl.add(getPanelComandos(), BorderLayout.CENTER);
    ...
    private JPanel getPanelCentral() {
        if (panelCentral == null) {
            ...
            panelCentral.add(getScrollGame(), BorderLayout.CENTER);
            panelCentral.add(getPanelSur(), BorderLayout.SOUTH);
        }
        return panelCentral;
    }
    ...
    private JPanel getScrollRanking() {
        if (scrollRanking == null) {
            ...
            scrollRanking.add(getJScrollPane(), BorderLayout.CENTER);
        }
    ...
    private JPanel getJPanel() {
        if (jPanel == null) {
            ...
            jPanel.add(getScrollRanking(), BorderLayout.CENTER);
    ...
    private JPanel getJPanel1() {
        if (jPanel1 == null) {
            ...
            jPanel1.add(getConexionTestPanel(), BorderLayout.CENTER);
...
//            jContenPane.add(getJEPanuncios(), BorderLayout.CENTER);
    ...
    private JPanel getRoomPanel() {
        if (jProomPanel == null) {
            jProomPanel = new JPanel();
            jProomPanel.setSize(750, 470);
            jProomPanel.setLayout(new BorderLayout());
            jProomPanel.add(getPanelPrincipal(), BorderLayout.CENTER);
        }
        return jProomPanel;
    }
