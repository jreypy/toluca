...
//			ret.put(DbOperations.PASSWORD, "asdf");
            ...
            String tmp = "Se necesita la ubicacin del archivo: " + props;
            logger.error(tmp);
    ...
    /**
     * <p>
     * Se ejecuta cuando un Jugador se autentic correctameente. Recorre el
...
//            logger.debug("Se disparo login Completed");
    ...
    public synchronized void showHashMap(HashMap ht) {
    ...
    public synchronized void showList(List l) {
