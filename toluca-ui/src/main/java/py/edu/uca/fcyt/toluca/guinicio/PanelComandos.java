...
public class PanelComandos extends JPanel {
    ...
    private JPanel getPuntaje() {
        if (panelPuntaje == null) {
            ...
            panelPuntaje.setForeground(Color.white);
            panelPuntaje.setOpaque(true);
            panelPuntaje.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createMatteBorder(2,2,2,2,Color.lightGray), "Trucometro", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", java.awt.Font.BOLD, 12), Color.blue));
            ...
            jLmaximo.setBackground(Color.white);
            ...
            jLsegundo.setBackground(Color.white);
            ...
            jLtercero.setBackground(Color.white);
            ...
            jLcuarto.setBackground(Color.white);
            ...
            jLquinto.setBackground(Color.white);
            ...
            jLsexto.setBackground(Color.white);
