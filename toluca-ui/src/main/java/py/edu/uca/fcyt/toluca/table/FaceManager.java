...
class FaceManager implements Animable
{
	...
	)
	{
        ...
        {
        	// obtiene la i-sima silla y el TrucoPlayer sentado en ella
     ...
     * caritas a falso exepto la que est en <code>index</code>
     * @param index		ndice de la carita a resaltar, si es
...
//    			System.out.println("Face " + index + " highlighted");
    ...
    synchronized public void showSign(int pos, int sign)
    {
    	...
    	// obtiene la carita en la posicin 'pos'
    	face = (Face) faces.get(pos);
    	
    	// establece la sea de la carita
    ...
    /**
     * Retorna una carita
     * @param index 	ndice de la carita
     */
	...
	/**
     * Remueve las caritas marcadas para eliminacin
     */
	...
	/**
     * Retorna las estados estndar de cada carita
     ...
     * terminando sus transiciones despus que las dems caritas.
...
//        System.out.println("aasdas: " + (toHide + delta));
     ...
     * @param pos	posicin de la carita
