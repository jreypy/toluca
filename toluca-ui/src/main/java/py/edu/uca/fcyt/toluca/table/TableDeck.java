...
class TableDeck implements Animable
{
	...
	// construye un TableDeck con 'nCards' cartas representndolo
	...
	// agrega una nueva posicin del maso
	...
	/**
     * Agrega una pausa a la animacin del maso
     */
	...
	// devuelve la 'index'-sima carta que conforma el maso
