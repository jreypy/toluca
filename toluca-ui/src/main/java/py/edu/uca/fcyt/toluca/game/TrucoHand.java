...
public class TrucoHand {
    ...
    protected void dealtCards() throws InvalidPlayExcepcion {
        ...
        try {
            ...
            // TODO COMMENTED-out porque daba una excepcin:
            // Teora de PS: No hace falta. Llamada al pedo que no va a volver
            // Teora de AA: Est mal el tipo del evento noms.
            //game.fireCardsDealt();
...
//        System.out.println("display Fin de envido con exito");
    ...
    public boolean esPosibleJugar(TrucoPlay tp) {
        ...
        case TrucoPlay.FLOR:
            ...
            /*//Parche porcino, le caga si el mismo equipo tiene ms de una Flor
     ...
     * @throws InvalidPlayExcepcion
     *             Tita en caso de detectarse una jugada invlida.
     */
...
//        System.out.println("probando en trucohand la carta");
    ...
    protected int getNumberOfPlayer(TrucoPlayer tp) {
        // RSHK - cambi (decia getNumberOfPLayer(tp)) porque no haba
