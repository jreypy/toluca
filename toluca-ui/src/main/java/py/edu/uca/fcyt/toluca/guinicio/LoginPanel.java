...
public class LoginPanel extends JPanel {
    ...
    private JPanel getJPpassword() {
        if (jPpassword == null) {
            ...
            jPpassword.add(getJPasswordField(), BorderLayout.CENTER);
            jPpassword.add(getJPbuttones(), BorderLayout.SOUTH);
        }
        return jPpassword;
    }
     ...
     * @return javax.swing.JPanel
     */
    private JPanel getJPbuttones() {
        if (jPbuttones == null) {
            jPbuttones = new JPanel();
