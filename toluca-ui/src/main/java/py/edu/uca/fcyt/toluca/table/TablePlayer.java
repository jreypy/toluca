...
{
	// contiene el par (TableCard, Posicin)
...
//	}
	...
	private int posX, posY;	// posicin x e y de la repartida
	private double angle;	// ngulo de repartida
	private int playerPos;			// nmero de silla
	...
	public TablePlayer(int playerPos, int playerCount, TableCard tCards[])
	{
		...
		(
			...
			"Parmetro 'playerPos' invlido"
		);

		// establece la posicin (x, y) y el ngulo de juego
		switch (playerCount)
		{
			case 2:
			...
			case 6:
				...
				break;
			default:
				throw new RuntimeException("Cantidad de jugadores invlido");
		}
		...
		// carga la posicin del jugador
		this.playerPos = playerPos;
		
		// crea la lista enlazada de las cartas que se jugarn
		// y el de cartas que se restaurarn
	...
	/**
	 * Pone la posicion finales de la 'index'-sima carta boca
	 * abajo y de manera desordenada (la reparte), con
	 * una duracin de animacin 'duration'
	 */
	...
	/**
	 * Establece los datos de animacin
	 * para jugar una carta.
	 * @param tCard		TableCard a jugar
	 * @param duration	duracin de la animacin
	 */
	...
	/**
     * Retorna la 'index'-sima carta jugada
     */
	...
	/**
     * Retorna la 'index'-sima carta no jugada
     */
	...
	/**
     * Retorna la 'index'-sima carta en la mano
     */
	...
	/**
     * Retorna la 'index'-sima carta en la mesa
     */
	...
	/**
	 * Establece los datos de animacin para mostrar las cartas
	 * del jugador (que debe estar en la posicin 0)
	 * @param duration	duracin de la animacin
	 */
	...
	/**
	 * Establece los datos de animacin para "abrir" o "cerrar" las
	...
	/**
	 * Pone la posicin y ngulo de la carta a la posicin
	 * de coleccin de un cierto TablePlayer
	 */
	...
	// retornan la posicin (x, y) de reparticin
     ...
     * @param duration	duracin de la pausa
     */
