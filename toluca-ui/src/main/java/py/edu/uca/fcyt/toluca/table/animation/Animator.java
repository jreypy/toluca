...
public class Animator implements Runnable, ObjectsPainter {
    ...
    protected void drawBack(BufferedImage img) {
        ...
        // obtiene el BufferedImage y el Graphics2D bfer
    ...
    /**
     * Establece la posicin del objeto animable <b>a </b> al primer lugar por
    ...
    /*
     * Retorna un objeto animable @param index ndice del objeto
     */
    ...
    /**
     * Finaliza la ejecucin de este animador
     */
