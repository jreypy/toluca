...
//	}
    ...
    public String description() {
        ...
        if (type == CONTRA_FLOR_ALRESTO) {
            return "CONTRA_FLOR_ALRESTO";
        }
        if (type == CON_FLOR_ME_ACHICO) {
            return "CON_FLOR_ME_ACHICO";
        }
        if (type == TRUCO) {
            return "TRUCO";
        }
        ...
        if (type == ME_VOY_AL_MAZO) {
            return "ME_VOY_AL_MAZO";
        }
        if (type == CANTO_ENVIDO) {
            return "CANTO_ENVIDO";
        }
        if (type == JUGAR_CARTA) {
            return "JUGAR_CARTA";
        ...
        if (type == CERRARSE) {
            ...
            logger.warn("Jugada no registrada [" + type + "]");
        }
    ...
    static TrucoPlay getTrucoPlay(TrucoPlayer trucoPlayer, byte type) {
        TrucoPlay trucoPlay = new TrucoPlay();
        trucoPlay.type = type;
        trucoPlay.player = trucoPlayer;
        return trucoPlay;

    }
    static TrucoPlay getTrucoPlay(TrucoPlayer trucoPlayer, byte type, TrucoCard trucoCard) {
        TrucoPlay trucoPlay = new TrucoPlay();
        trucoPlay.type = type;
        trucoPlay.player = trucoPlayer;
        trucoPlay.card = trucoCard;
        return trucoPlay;
    }
